	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
				...
				<form class="form-horizontal" action="?page=buktipengambilan_tambah" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								...
								$query = "SELECT DISTINCT tanggal FROM data_buku_pengeluaran order by tanggal ASC";
