				...
				<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="number" name="volumemasuk" id="volumemasuk" class="form-control" readonly
									<?php
								// ambil data dari database
								...
								while ($row = mysqli_fetch_array($hasil)) {
								?>
									max="<?php echo $row['jumlah_stok'] ?>" min="0" value="<?php echo $data_cek['vlm_masuk']; ?>" >
									<?php
								}
								?>
								</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="number" class="form-control" id="hargasatuan" name="hargasatuan" placeholder="Masukkan Harga Satuan" value="<?php echo $data_cek['hrg_satuan']; ?>" min="0" readonly>
							</div>
						</div>

						<div class="form-group">
							<label class="col-sm-2 control-label">Jumlah Harga</label>
							<div class="col-sm-3">
								<input type="number" class="form-control" id="jumlahharga" name="jumlahharga" placeholder="Masukkan Jumlah Harga" value="<?php echo $data_cek['jml_harga']; ?>" min="0" readonly>
							</div>
						</div>
...
if(isset($_POST['Hapus'])){
	...
	$a1 = ($stokbarang-$barangmasuk);
			$sql_hapus = "DELETE FROM data_buku_penerimaan WHERE id_msuk='".$_GET['id_msuk']."';";
