		...
		<div class="col-md-12">
			...
			<div class="box box-success">
				<div class="box-header with-border">
					<h3 class="box-title">Ubah Data Buku Pengeluaran</h3>
				...
				<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="date" class="form-control" id="tanggal" name="tanggal" max="<?php echo date("Y-m-d"); ?>">
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">Volume Keluar Baru</label>
							<div class="col-sm-2">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">Volume Keluar Lama</label>
							<div class="col-sm-2">
								<input type="text" name="volumekeluarlama" id="volumekeluarlama" class="form-control" readonly
									<?php
								// ambil data dari database
								$query = "SELECT * FROM data_buku_pengeluaran WHERE id_keluar='".$_GET['id_keluar']."'";
								$hasil = mysqli_query($koneksi, $query);
...
if (isset ($_POST['Ubah'])){
	...
	$barangkeluarlama = $_POST['volumekeluarlama'];
	$barangkeluar = $_POST['volumekeluar'];
    $stokbarang = $_POST['stok'];
	$a1 = ($stokbarang+$barangkeluarlama)-$barangkeluar;
    //mulai Mahasiswaoses ubah
    $sql_ubah = "UPDATE data_buku_pengeluaran SET
		tanggal='".$_POST['tanggal']."',
		bulan='".$_POST['bulan']."',
		kd_brng='".$_POST['kodebarang']."',
		nma_brng='".$_POST['namabarang']."',
		satuan='".$_POST['satuan']."',
		vlm_keluar='".$_POST['volumekeluar']."'
		WHERE id_keluar='".$_POST['idkeluar']."';";
    ...
    if ($query_ubah) {
		...
		echo "<meta http-equiv='refresh' content='0; url=index.php?page=bukupengeluaran_ubah'>";
	}
}
?>
