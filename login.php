...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<div class="login-box-body">
			<center>
				<img src="dist/img/baca.png" width=170px />
				<h4>
					<b>
						SISTEM INFORMASI PENGELOLAAN <br> BARANG MASUK DAN BARANG KELUAR
					</b>
				</h4>
				<BR>
			</center>
...
<?php 
		...
		$jumlah_login = mysqli_num_rows($query_login);
            ...
            if ($jumlah_login == 1 ){
			  ...
			  $_SESSION["ses_unit"]=$data_login["unit_kerja"];
              $_SESSION["ses_level"]=$data_login["bagian"];
