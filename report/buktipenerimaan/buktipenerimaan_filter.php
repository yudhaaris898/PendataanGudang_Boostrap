		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-border">
						<h4>Cetak Bukti Penerimaan Barang</h4>
				...
				<form class="form-horizontal" target="_blank" action="report/buktipenerimaan/buktipenerimaan_cetak.php" method="post" enctype="multipart/form-data">
					<div class="box-body">
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								...
								$query = "SELECT DISTINCT tanggal FROM data_bukti_penerimaan order by tanggal ASC";
