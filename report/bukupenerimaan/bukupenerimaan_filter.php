		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-border">
						<h4>Cetak Buku Penerimaan Barang</h4>
				...
				<form class="form-horizontal" target="_blank" action="report/bukupenerimaan/bukupenerimaan_cetak.php" method="post" enctype="multipart/form-data">
					<div class="box-body">
